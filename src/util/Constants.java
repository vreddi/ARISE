...
public class Constants {
    ...
    public static final int connectTimeout = 10000;  //  Timeout if connection has not been established after 5 seconds.
    public static final int readTimeout = 10000; //  Timeout if input has not been available after 5 seconds.
    public static final int sourceExecutionTimeout = 10000; //    Timeout if a source executed for more than 5 seconds without returning.
